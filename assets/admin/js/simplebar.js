            ...
            if (
                ...
                if (
                    ...
                    if (objectSetPrototypeOf) {
                        ...
                        typeof CurrentIteratorPrototype[ITERATOR$1] !=
                        "function"
                    ) {
                        hide(
                            CurrentIteratorPrototype,
                ...
                _export(
                    {
                        ...
                        proto: true,
                        forced:
                            BUGGY_SAFARI_ITERATORS$1 || INCORRECT_VALUES_NAME,
                    },
                    methods
                );
        }
                    ...
                    ? {
                          ...
                          get: function get(key) {
                              ...
                              if (isObject(key)) {
                                  var data = getWeakData(key);
                                  if (data === true)
                                      return uncaughtFrozenStore(state).get(
                                          key
                                      );
    ...
    function isSymbol$1(value) {
        return (
            ...
            (isObjectLike$1(value) &&
                objectToString$2.call(value) == symbolTag$1)
        );
    }
    ...
    var Scheduler = (function () {
        ...
        Scheduler.prototype.start = function () {
            ...
            if (this.stopped) {
                ...
                events.forEach(function (name) {
                    return global$1.addEventListener(
                        name,
                        _this.listener,
                        true
                    );
        ...
        Scheduler.prototype.stop = function () {
            ...
            if (!this.stopped) {
                ...
                events.forEach(function (name) {
                    return global$1.removeEventListener(
                        name,
                        _this.listener,
                        true
                    );
            ...
            return [
                ...
                function (regexp, replaceValue) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        var position = max$1(
                            min$2(toInteger(result.index), S.length),
                            0
                        );
                        var captures = [];
        ...
        (function () {
            ...
            SimpleBar.getRtlHelpers = function getRtlHelpers() {
                ...
                var dummyContainerOffset =
                    SimpleBar.getOffset(scrollbarDummyEl);
            ...
            _proto.onTrackClick = function onTrackClick(e, axis) {
                ...
                var scrollbar = this.axis[axis].scrollbar;
                var scrollbarOffset =
                    scrollbar.rect[this.axis[axis].offsetAttr];
                var hostSize = parseInt(
                    this.elStyles[this.axis[axis].sizeAttr],
                    10
                );
                    ...
                    if (addedNode.nodeType === 1) {
                        if (addedNode.hasAttribute("data-simplebar")) {
                            ...
                            Array.prototype.forEach.call(
                                ...
                                function (el) {
                                    if (
                                        el.getAttribute("data-simplebar") !==
                                            "init" &&
                                        !SimpleBar.instances.has(el) &&
